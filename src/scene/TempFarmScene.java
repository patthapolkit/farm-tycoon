...
//        buttonContainer.getChildren().addAll(barnButton, plotButton, factButton, shopButton, martButton, cageButton,farmButton);
//
//        // container setup
...
//    }
//
//    public void farmButtonSetup() {
//        farmButton = new GameButton(200, 50, 40, Color.rgb(124, 153, 182));
//        farmButton.addText("Farm", 30, Color.WHITE);
//        farmButton.addEventHandler(MouseEvent.MOUSE_CLICKED, new EventHandler<MouseEvent>() {
//            public void handle(MouseEvent e) {
//                HomeMenuScene.getRoot().getChildren().add(new RealFarmScene());
//            }
//        });
//    }
//}
